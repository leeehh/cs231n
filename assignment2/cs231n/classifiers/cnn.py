...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        out = X
        out, cache1 = conv_forward_fast(out,self.params['W1'],self.params['b1'],conv_param)
        out, cache2 = relu_forward(out)
        out, cache3 = max_pool_forward_fast(out,pool_param)
        out, cache4 = affine_relu_forward(out,self.params['W2'],self.params['b2'])
        out, cache5 = affine_forward(out,self.params['W3'],self.params['b3'])
        scores = out
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout,grads['W3'],grads['b3'] = affine_backward(dout,cache5)
        dout,grads['W2'],grads['b2'] = affine_relu_backward(dout,cache4)
